// The field names differ from the field names in G0/G4/L5 reference manual, but
// match the field descriptions. The field descriptions appear to be
// correct. See https://github.com/stm32-rs/fdcan/issues/4
...
impl R {
    ///Bit 0 - Enable Interrupt Line 1
    #[inline(always)]
    pub fn eint1(&self) -> EINT1_R {
        EINT1_R::new((self.bits & 0x01) != 0)
    }
    ///Bit 1 - Enable Interrupt Line 0
    #[inline(always)]
    pub fn eint0(&self) -> EINT0_R {
        EINT0_R::new(((self.bits >> 1) & 0x01) != 0)
    }
}
impl W {
    ///Bit 0 - Enable Interrupt Line 1
