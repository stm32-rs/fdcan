...
use super::enums::{
    BitRateSwitching, DataLength, ErrorStateIndicator, Event, EventControl,
    FrameFormat, IdType, RemoteTransmissionRequest,
};
use super::generic;

#[doc = "Reader of register TxBufferElement"]
pub(crate) type R =
    generic::R<super::TxBufferElementHeaderType, super::TxBufferElementHeader>;
#[doc = "Writer for register TxBufferElement"]
pub(crate) type W =
    generic::W<super::TxBufferElementHeaderType, super::TxBufferElementHeader>;
...
impl<'a> ESI_W<'a> {
    ...
    pub fn bit(self, value: bool) -> &'a mut W {
        self.w.bits[0] =
            (self.w.bits[0] & !(0x01 << 31)) | (((value as u32) & 0x01) << 31);
        self.w
    }
}
...
impl<'a> XTD_W<'a> {
    ...
    pub fn bit(self, value: bool) -> &'a mut W {
        self.w.bits[0] =
            (self.w.bits[0] & !(0x01 << 30)) | (((value as u32) & 0x01) << 30);
        self.w
    }
}
...
impl<'a> RTR_W<'a> {
    ...
    pub fn bit(self, value: bool) -> &'a mut W {
        self.w.bits[0] =
            (self.w.bits[0] & !(0x01 << 29)) | (((value as u32) & 0x01) << 29);
        self.w
    }
}
...
impl<'a> DLC_W<'a> {
    ...
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
        self.w.bits[1] =
            (self.w.bits[1] & !(0x0F << 16)) | (((value as u32) & 0x0F) << 16);
        self.w
    }
}
...
impl<'a> BRS_W<'a> {
    ...
    pub fn bit(self, value: bool) -> &'a mut W {
        self.w.bits[1] =
            (self.w.bits[1] & !(0x01 << 20)) | (((value as u32) & 0x01) << 20);
        self.w
    }
}
...
impl<'a> FDF_W<'a> {
    ...
    pub fn bit(self, value: bool) -> &'a mut W {
        self.w.bits[1] =
            (self.w.bits[1] & !(0x01 << 21)) | (((value as u32) & 0x01) << 21);
        self.w
    }
}
...
impl<'a> EFC_W<'a> {
    ...
    pub fn bit(self, value: bool) -> &'a mut W {
        self.w.bits[1] =
            (self.w.bits[1] & !(0x01 << 23)) | (((value as u32) & 0x01) << 23);
        self.w
    }
}
...
impl<'a> MM_W<'a> {
    ...
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
        self.w.bits[1] =
            (self.w.bits[1] & !(0x7F << 24)) | (((value as u32) & 0x7F) << 24);
        self.w
    }
