...
impl<ID, UNIT> From<FilterType<ID, UNIT>> for crate::message_ram::enums::FilterType
where
    ID: Copy + Clone + core::fmt::Debug,
    UNIT: Copy + Clone + core::fmt::Debug,
{
...
impl From<Action> for crate::message_ram::enums::FilterElementConfig {
